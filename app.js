  ...
  return `<div class="loading">
    <div style="position:relative;z-index:1;display:flex;flex-direction:column;align-items:center;gap:16px">
      <div style="position:relative;width:64px;height:64px">
        <svg viewBox="0 0 80 80" style="width:80px;height:80px;animation:spin 1.8s linear infinite;filter:drop-shadow(0 0 12px rgba(229,9,20,0.8))">
          <circle cx="40" cy="40" r="34" fill="none" stroke="rgba(229,9,20,0.08)" stroke-width="2"/>
          <circle cx="40" cy="40" r="34" fill="none" stroke="url(#roxGrad)" stroke-width="3" stroke-linecap="round" stroke-dasharray="60 154"/>
          <circle cx="40" cy="40" r="26" fill="none" stroke="rgba(229,9,20,0.15)" stroke-width="1.5"/>
          <circle cx="40" cy="40" r="26" fill="none" stroke="rgba(229,9,20,0.6)" stroke-width="1.5" stroke-linecap="round" stroke-dasharray="30 133" style="animation:spin 0.9s linear infinite reverse"/>
          <defs>
            <linearGradient id="roxGrad" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" style="stop-color:#ff6b6b"/>
              <stop offset="100%" style="stop-color:#e50914"/>
            </linearGradient>
          </defs>
        </svg>
        <div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:900;color:#fff;letter-spacing:3px;text-shadow:0 0 20px rgba(229,9,20,1)">ROX</div>
        <div style="position:absolute;inset:0;border-radius:50%;background:radial-gradient(circle,rgba(229,9,20,0.15) 0%,transparent 70%);animation:roxPulse2 2s ease-in-out infinite"></div>
      </div>
...
function openAnimationHub() {
  ...
  const ANIM_CHANNELS = [
    // ── قنوات غربية ──
    { id:'cartoonnetwork', name:'Cartoon Network', color:'#ff6b00', logo:'https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Cartoon_Network_2010_logo.svg/200px-Cartoon_Network_2010_logo.svg.png', networkIds:[56], tvOnly:true },
    { id:'nickelodeon',    name:'Nickelodeon',     color:'#ff8c00', logo:'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a1/Nickelodeon_2009_logo.svg/200px-Nickelodeon_2009_logo.svg.png', networkIds:[13], tvOnly:true },
    { id:'disney',         name:'Disney Channel',  color:'#0d47a1', logo:'https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Disney_Channel_2014_logo.svg/200px-Disney_Channel_2014_logo.svg.png', networkIds:[54], tvOnly:true },
    { id:'disneyjr',       name:'Disney Junior',   color:'#e91e63', logo:'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Disney_Junior_logo.svg/200px-Disney_Junior_logo.svg.png', networkIds:[302], tvOnly:true },
    { id:'disneyxd',       name:'Disney XD',       color:'#1565c0', logo:'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Disney_XD_2015_logo.svg/200px-Disney_XD_2015_logo.svg.png', networkIds:[58], tvOnly:true },
    { id:'nickjr',         name:'Nick Jr',         color:'#ff6d00', logo:'https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/Nick_Jr._logo_%282009%29.svg/200px-Nick_Jr._logo_%282009%29.svg.png', networkIds:[174], tvOnly:true },
    { id:'cbeebies',       name:'CBeebies',        color:'#ff5722', logo:'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/CBeebies_2022_logo.svg/200px-CBeebies_2022_logo.svg.png', networkIds:[228], tvOnly:true },
    { id:'cartoonito',     name:'Cartoonito',      color:'#ff9100', logo:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Cartoonito_logo.svg/200px-Cartoonito_logo.svg.png', networkIds:[2552], tvOnly:true },
    { id:'boomerang',      name:'Boomerang',       color:'#e53935', logo:'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Boomerang_logo_2015.svg/200px-Boomerang_logo_2015.svg.png', networkIds:[2555], tvOnly:true },
    { id:'pbs',            name:'PBS Kids',        color:'#1b5e20', logo:'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/PBS_Kids_Logo.svg/200px-PBS_Kids_Logo.svg.png', networkIds:[1104], tvOnly:true },
    { id:'adultsw',        name:'Adult Swim',      color:'#7b1fa2', logo:'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Adult_Swim_2003_logo.svg/200px-Adult_Swim_2003_logo.svg.png', networkIds:[213], tvOnly:true },
    { id:'fox',            name:'FOX',             color:'#e53935', logo:'https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/FOX_logo.svg/200px-FOX_logo.svg.png', networkIds:[19], tvOnly:true },
    { id:'abc',            name:'ABC',             color:'#1565c0', logo:'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/ABC_Logo.svg/200px-ABC_Logo.svg.png', networkIds:[2], tvOnly:true },
    { id:'cartoon2',       name:'Cartoon Net 2',   color:'#ff6b00', logo:'https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Cartoon_Network_2010_logo.svg/200px-Cartoon_Network_2010_logo.svg.png', networkIds:[2666], tvOnly:true },
    // ── قنوات عربية ──
    ...
    { id:'mbc',       name:'MBC',       color:'#1565c0', logo:'https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/MBC3_logo.svg/200px-MBC3_logo.svg.png', networkIds:[2153], tvOnly:true },
    // ── منصات ──
